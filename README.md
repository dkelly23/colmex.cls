# colmex.cls
Formato .cls de LaTex para simplificar la creación de notas basadas en el formato de reporte. El .cls añade además un conjunto de comandos para facilitar la toma de apuntes en matemáticas. 
